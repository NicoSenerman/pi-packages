...
> **Privacy:** TODO subject/description text is injected into the system prompt and therefore reaches your model provider — never put secrets in a TODO (same rule as AGENTS.md / context files).
