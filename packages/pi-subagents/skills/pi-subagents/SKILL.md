...
description: |
  ...
  Triggers on "subagent", "subagents", "delegat", "worker", "reviewer",
  "scout", "oracle", "planner", "researcher", "context-builder", "delegate",
  "research", "explore", "investigate", "review loop", "parallel review",
  "chain", "/run", "/chain", "/parallel", "fanout", "pi-subagents",
  "implementation handoff", "advisory review", "async worker", "forked context",
  "context build", "handoff plan", "parallel", "review", "handoff",
  "async", "second opinion", "break into steps", "have another agent",
  "spin up", "another pair of eyes".
---
